...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  // Open Inventory if on any inventory subpage
  ...
  // Auto-scroll to Inventory when expanded
  useEffect(() => {
  ...
  return (
    <div
      className={clsx(
        "w-64 bg-white dark:bg-[#0b1437] shadow-xl lg:shadow-none"
      )}
    >
                      ...
                      {inventoryOpen && (
                        <ul
                          ...
                          className={clsx(
                            ...
                            inventoryOpen ? "max-h-[999px]" : "max-h-0"
                          )}
