        ...
        return (
          <motion.div
            ...
            className={`flex-1 rounded-sm ${
              isLast ? "bg-gradient-to-t from-purple-500 to-blue-500" : "bg-gray-400/50"
            }`}
          />
        )
      })}
...
function MetricCard({ title, value, change, trend, icon, chartData, delay = 0 }: MetricCardProps) {
  return (
    ...
    >
      <Card className="bg-white/20 backdrop-blur-lg border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300">
