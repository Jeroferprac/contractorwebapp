    ...
    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }}>
      <Card className="bg-white/20 backdrop-blur-lg border border-white/30 shadow-lg dark:bg-[#020817]/40 dark:backdrop-blur-xl dark:border-white/10 dark:shadow-2xl dark:shadow-purple-500/5">
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="text-gray-700 hover:bg-white/30 dark:text-gray-300 dark:hover:bg-white/10 dark:hover:text-white transition-all duration-200"
            >
        ...
        <CardContent className="pt-0">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent dark:from-purple-400 dark:to-blue-400">
                    73%
                  </div>
          ...
          <Button className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white rounded-xl py-3 shadow-lg dark:shadow-purple-500/20 transition-all duration-300 hover:shadow-xl dark:hover:shadow-purple-500/30">
            Deposit now
          </Button>
        </CardContent>
      </Card>
