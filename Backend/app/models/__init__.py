...
from .inventory import Product, Supplier, ProductSupplier,Sale,SaleItem,PurchaseOrder,PurchaseOrderItem
...
__all__ = ["User", "UserSession", "Quotation", "QuotationAttachment", "ContractorProfile", "Project", "ProjectMedia", 
           "Product", "Supplier", "ProductSupplier", "Sale", "SaleItem","PurchaseOrder", "PurchaseOrderItem"]
